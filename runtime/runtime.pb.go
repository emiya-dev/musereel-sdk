...
const file_runtime_proto_rawDesc = "" +
	...
	"\x05tiers\x18\x01 \x03(\v2\x15.runtime.v1.TokenTierR\x05tiers\"V\n" +
	"\fPerImageTier\x12\x1e\n" +
	"\n" +
	"resolution\x18\x01 \x01(\tR\n" +
	"resolution\x12&\n" +
	"\x0funits_per_image\x18\x02 \x01(\tR\runitsPerImage\"?\n" +
	"\rPerImagePrice\x12.\n" +
	"\x05tiers\x18\x01 \x03(\v2\x18.runtime.v1.PerImageTierR\x05tiers\"Y\n" +
	"\rPerSecondTier\x12\x1e\n" +
	"\n" +
	"resolution\x18\x01 \x01(\tR\n" +
	"resolution\x12(\n" +
	"\x10units_per_second\x18\x02 \x01(\tR\x0eunitsPerSecond\"A\n" +
